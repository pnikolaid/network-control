...
openrtist_mean_off_time = 4*60
openrtist_minimum_on_time = 2*60
openrtist_minimum_off_time = 2*60
...
bandwidth_demand_estimator = "vucb1-per-hop"  # "static", "basic", "vucb1", 'vucb1-per-hop', 'vucb1-per-hop-corr', 'max-estimation', 'tcp'
